...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        camera_x->setMinimum(-1000);
        camera_x->setMaximum(1000);
        camera_x->setValue(278);
        ...
        camera_y->setMinimum(-1000);
        camera_y->setMaximum(1000);
        camera_y->setSingleStep(10);
        camera_y->setValue(278);
        ...
        camera_z->setMinimum(-1000);
        camera_z->setMaximum(1000);
        camera_z->setValue(-800);
        ...
        point_x->setMinimum(-1000);
        point_x->setMaximum(1000);
        point_x->setValue(278);
        ...
        point_y->setMinimum(-1000);
        point_y->setMaximum(1000);
        point_y->setValue(278);
        ...
        point_z->setMinimum(-1000);
        point_z->setMaximum(1000);
        point_z->setValue(0);
